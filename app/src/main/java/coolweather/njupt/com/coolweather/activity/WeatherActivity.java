package coolweather.njupt.com.coolweather.activity;
...
public class WeatherActivity extends Activity implements View.OnClickListener{
    ...
    private Button mBtnSwitchCity;  //切换城市按钮
    private Button mBtnRefreshWeather;   //刷新天气
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSwitchCity.setVisibility(View.VISIBLE);
        mBtnRefreshWeather.setVisibility(View.VISIBLE);
